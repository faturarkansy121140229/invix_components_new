...
const SideBar = () => {
  ...
  return (
    <div className="flex">
      <div className="relative w-16 min-h-screen h-full flex flex-col bg-gradient-to-t from-cyan-200 to-white p-6 transition-all duration-300 shadow-[0_0px_5px_3px_rgba(0,0,0,0.2)]">
        ...
        <div className="sidebar head flex gap-5 pb-5 pt-5 border-b border-t border-gray-300 mb-2">
          ...
          {/* <div className="user-details">
            <div className="title text-[14px] font-medium uppercase">
              Fatur Arkan
            </div>
            <span className="text-gray-500 text-xs font-medium mb-2.5">
              fatur@gmail.com
            </span>
          </div> */}
        </div>
        <div className="flex-1">
          <div className="menu">
            ...
            {/* <p className="title text-sm font-semibold text-white mb-2 bg-orange-400 flex justify-center mt-2 rounded-[20px]">
              Tracker
            </p> */}
            {/* <ul>
              <li
