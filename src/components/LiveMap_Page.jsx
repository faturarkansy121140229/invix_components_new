...
const LiveMap = () => {
    ...
    return (
        <div className="h-screen w-full relative">
            <div
                className={`absolute inset-y-0 left-0 w-[360px] z-10 bg-white bg-opacity-80 shadow-md my-5 p-4 rounded-tr-[10px] rounded-br-[10px] transition-all duration-500 ease-in-out ${isContainerVisible ? 'transform translate-x-0' : 'transform -translate-x-full'}`}
            >
                ...
                <button
                    ...
                    className="absolute left-[360px] top-[20px] w-8 h-8 bg-white opacity-80 transform rounded-r-lg pl-1.5"
                >
                    <img
                ...
                <p className="text-sm font-semibold my-1 ml-1">Welcome, Fatur Arkan Syawalva</p>
                <Search />
                <div className="flex justify-between mb-4 bg-white border border-gray-300 p-2 px-3 rounded-lg">
                    <div className="flex items-center mr-2">
                        ...
                        />
                        <label htmlFor="default-checkbox-1" className="ms-2 text-sm font-medium text-green-500">Move</label>
                    </div>
                    <div className="flex items-center mr-2">
                        <input
                            ...
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="default-checkbox-2" className="ms-2 text-sm font-medium text-yellow-300">Park</label>
                    </div>
                    <div className="flex items-center mr-2">
                        <input
                            ...
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="default-checkbox-3" className="ms-2 text-sm font-medium text-red-600">Off</label>
                    </div>
                    <div className="flex items-center">
                        <input
                            ...
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="default-checkbox-4" className="ms-2 text-sm font-medium text-gray-400">Miss</label>
                    </div>
                </div>
                        ...
                        >
                            <div className="grid grid-cols-3 gap-3 mb-2">
                                <div className='flex flex-col h-full justify-between'>
                                    {vehicle.jenis === 'mobil' ? (
                                        <img src="images/car.svg" alt="Car" className="mx-auto w-30 mb-2" />
                                    ) : vehicle.jenis === 'truk' ? (
                                        <img src="images/truck.svg" alt="Truck" className="mx-auto w-30 mb-2" />
                                    ) : (
                                        <img src="images/motorcycle.svg" alt="Motorcycle" className="mx-auto w-30 mb-2" />
                                    )}
                                    {vehicle.status === 'move' ? (
                                ...
                                <div className="col-span-2 flex flex-col justify-between min-h-full">
                                    ...
                                    <div className="flex items-center justify-between text-gray-500 text-xs ml-3">
            ...
            <MapContainer center={[-1.7, 118.5]} zoom={5} className="h-full w-full z-0">
                <TileLayer
